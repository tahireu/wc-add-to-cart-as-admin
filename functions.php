 ...
 * */
if ( !function_exists( 'atcaa_prepare' ) ) {
 ...
 * */
if ( !function_exists( 'atcaa_check_required_fields' ) ) {
 ...
 * */
if ( !function_exists( 'atcaa_check_field_length' ) ) {
 ...
 * */
if ( !function_exists( 'atcaa_get_string_between' ) ) {
